...
public:
  ...
  /**
   * @brief Prints an error message to the console. If popup is true, it will also display a popup with the error
   * message.
  ...
  /**
   * @brief Displays dialog box when game is finished and resets the game so both players are back at the connection
   * panel.
   */
