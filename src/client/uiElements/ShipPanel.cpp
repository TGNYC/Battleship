...
ShipPanel::ShipPanel(wxWindow *parent, wxPoint pos, [[maybe_unused]] std::array<bool, 5> sunk)
  ...
  for (size_t i = 0; i < 5; ++i) {
    _shipBitmaps[i] = new wxStaticBitmap(this, wxID_ANY, wxBitmap(wxImage(_filenames[i])),
